...
def playGame(GamesPlayed, WinNumber, HighScoreStreak, GameWinStreak, PercWin):
    ...
    while guess != secretWord:
        ...
        #print(secretWord) #I have this here for testing purposes  
    ...
    if tooManyGuesses:
        ...
        print("----- standings -----")
        print(f"you are in {str(UserPosition + 1)} place")
        print("Top Three Players")
        print("\n".join([f"(position {x+1}): {UserRecords[x]}" for x in range(len(UserRecords))]))
        print(UserPosition + 1)
        ...
        #for loop for guessdistro if player wrong
        for i in range(0, MaxGuess):
            print(f"{i+1}:{guessDistribution[i]}")
        ...
        for i in range(0, MaxGuess):
            UserRecords[UserPosition][i+MaxGuess] = str(guessDistribution[i])
        ...
        print("Top Three Players")
        #for i in range(0,3):
            #print(f"(position{i+1}){(UserRecords[i])}")
        print("\n".join([f"(position {x+1}): {UserRecords[x]}" for x in range(len(UserRecords))]))
        print("--------------------")
       ...
       #sets new win streak
        ...
        #for loop for guessdistro if player right
        for i in range(0, MaxGuess):
            print(f"{i+1}:{guessDistribution[i]}")
...
while play:
    ...
    print("Top Three Players")
    #for i in range(0,3):
        #print(f"(position{i+1}){str(UserRecords[i])}")
    print("\n".join([f"(position {x+1}): {UserRecords[x]}" for x in range(len(UserRecords))]))
    print("--------------------")
